<x-adminlte-modal id="nuevo-rol" title="NUEVO ROL" size="lg" theme="primary"
    ...
    @endif
    <form id="formNuevoRol" action="{{route('sadmin.nuevo-rol')}}" method="post" class="needs-validation">
    @csrf
        <div class="container">
            <div class="row">
    ...
    <x-slot name="footerSlot">
        <x-adminlte-button type="submit" form="formNuevoRol" class="mr-auto btn btn-lg" theme="success" label="Registrar"/>

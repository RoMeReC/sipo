...
@section('content')
    ...
    <div class="card">
        ...
        <div class="container">
            <button class="btn btn-primary" title="Nuevo Tipo de Documento" data-toggle="modal" data-target="#nuevo-tipo-documento"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Nuevo Tipo de Documento</button>
        </div>
        

        <table id="sa-lista-tipo-documento" class="hover" style="width:100%">
            <thead>
                <tr>
                    <th>Nro</th>
    ...
    @include('sadmin.modal-nuevo-tipo-documento')
    ...
    @endif
    @include('sadmin.modal-editar-tipo-documento')
@stop
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-editar-rol', function() {
                ...
                $('#id_tipo_documentoEditar').val(tipoDocumentoId); 
                $('#tipo_documentoEditar').val(tipoDocumentoEditar);
                $('#descripcionEditar').val(descripcionEditar);
                
                $('#editar-tipo-documento').modal('show');
            });

            $('#agregar-tipo-documento').on('shown.bs.modal', function () {

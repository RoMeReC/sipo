<x-adminlte-modal id="agregar-usuario" title="AGREGAR USUARIO" size="sg" theme="success"
    ...
    <form id="formAgregarUsuario" action="{{route('admin.agregar-usuario')}}" method="post" class="needs-validation">
        ...
        <div class="container">
            <div class="row">
                <x-adminlte-select id="rol_usuario" name="rol_usuario" value="{{ old('rol_usuario') }}" label="ROL DE USUARIO:" label-class="text-lightblue" fgroup-class="col-md-12 {{ $errors->has('rol_usuario') ? 'has-error' : '' }}" disable-feedback required>
